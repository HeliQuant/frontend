    ...
    <div className="space-y-8">
      ...
      {reached === false && !log ? (
        ...
        <div className="space-y-px bg-bone/10">
          {/* header row */}
          <div className="hidden grid-cols-[160px_1fr_80px_80px_95px_150px] gap-3 bg-pitch px-5 py-2 font-mono text-[9px] uppercase tracking-[0.16em] text-steel lg:grid">
...
function TradeRow({ t, delay }: { t: Trade; delay: number }) {
  ...
  return (
    <motion.div
      ...
      className="grid grid-cols-2 items-center gap-3 bg-carbon px-5 py-3 lg:grid-cols-[160px_1fr_80px_80px_95px_150px]"
    >
        ...
        {(() => {
          ...
          return (
            <span
              ...
              className={`whitespace-nowrap border px-1 py-0.5 font-mono text-[8px] font-bold uppercase tracking-[0.08em] ${
