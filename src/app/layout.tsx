...
const SITE = "https://heliquant.vercel.app";
const DESC =
  "Autonomous multi-desk AI trading firm on Mantle, built like an engine: nine desks ingest, the PM " +
  "sparks ENTER only on a validated edge — otherwise it holds (ABSTAIN). Every decision sealed " +
  "on-chain. We publish what doesn't work too.";

// metadataBase makes the generated /opengraph-image URL ABSOLUTE — required for WA / Telegram / X /
// Discord / IG link-preview crawlers. The OG image itself is generated by app/opengraph-image.tsx.
